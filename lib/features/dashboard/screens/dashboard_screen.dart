...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('MindEase', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 24)),
        centerTitle: true,
        elevation: 0,
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.black87, letterSpacing: -0.5),
              ),
      ...
      children: [
        Column(
          ...
          children: [
            ...
            Text(
              name,
              style: const TextStyle(fontSize: 32, fontWeight: FontWeight.w800, color: Colors.black87, letterSpacing: -1.0),
            ),
          ],
        ),
        CircleAvatar(
          ...
          child: Text(
            name[0],
            style: const TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: primaryColor),
          ),
        ),
      ],
    );
  ...
  Widget _buildQuickActionsRow(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [
        _buildQuickActionButton(context, 'Add Mood', Icons.add_reaction_rounded, const Color(0xFFFF9800), () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => const MoodHomeScreen()));
        }),
        _buildQuickActionButton(context, 'Meditate', Icons.self_improvement_rounded, const Color(0xFF009688), () {
          Navigator.push(context, MaterialPageRoute(builder: (_) => const MeditationHomeScreen()));
        }),
        _buildQuickActionButton(context, 'Journal', Icons.edit_note_rounded, const Color(0xFF2196F3), () {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Journal coming soon!')));
        }),
        _buildQuickActionButton(context, 'Breathe', Icons.air_rounded, const Color(0xFF9C27B0), () {
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Breathing exercise coming soon!')));
        }),
      ],
    );
  }
    ...
    return GridView.count(
      ...
      children: [
        _buildGridCard(
          ...
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const MoodHomeScreen())),
        ),
        _buildGridCard(
          title: 'Meditation',
          value: '15 Min',
          ...
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const MeditationHomeScreen())),
        ),
        _buildGridCard(
  ...
  Widget _buildDailyQuote() {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.format_quote_rounded, color: primaryColor.withValues(alpha: 0.4), size: 48),
          const SizedBox(height: 12),
          const Text(
            '"The mind is everything. What you think you become."',
            style: TextStyle(fontSize: 16, fontStyle: FontStyle.italic, color: Colors.black87, height: 1.6, fontWeight: FontWeight.w500),
            textAlign: TextAlign.center,
          ),
          const SizedBox(height: 16),
          Text(
            '- Buddha',
            style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: Colors.grey[500], letterSpacing: 1.0),
          ),
        ],
      ),
    );
